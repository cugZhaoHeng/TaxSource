	    ...
	    $(function(){
		    $("#taskTable").datagrid({
                ...
                columns:[[
                    ...
                    { field:"payerBean", title: '纳税人识别号', formatter:function(value, rowData, index) {
                    	if(value != null) {
                    		return value.payerCode
                    	}
                    }},
                    { field:"payerName", width:"180", title: '纳税人名称', formatter:function(value, rowData, index){
                    	return rowData.payerBean.payerName
                    }},
                    { field:"industryName", width:"160", title: '行业' , formatter:function(value, rowData, index){
                    	return rowData.payerBean.industryBean.industryName
                    }},
                    { field:"bizScope", width:"130", title: '经营范围', formatter:function(value, rowData, index){
                    	return rowData.payerBean.bizScope
                    }},
                    { field:"executeTime", title: '执行时间' },
                    { field:"recordDate", title: '录入时间' },
