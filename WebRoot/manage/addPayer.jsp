            ...
            <div title="纳税人信息" data-options="closable:false" class="basic-info">
                ...
                <table class="kv-table">
                    ...
                    <tr>
                        ...
                        <td class="kv-content"><input type="text" name="payerName" id="payerName" class="easyui-validatebox" data-options="validType:'payerName'"></td>
                    </tr>
                    <tr>
                        <td class="kv-label">生产经营地址</td>
                        <td class="kv-content">
                        	<select name="bizAddress" id="bizAddress">
...
<script type="text/javascript">
	...
	function add() {
		...
		var userId;
		var userBean;
		/* 为了方便将数据存入payer对象中，需要将userName转化为userId */
		$.post(
		...
		if(!/^[a-z|A-Z|\u4e00-\u9fa5|0-9]{0,64}$/.test(bizAddress)){
			$.messager.alert("提示","生产经营地址格式不正确，最大64位", "info");
			return false;
		}
		//生产经营地电话
		if(bizAddressPhone==""){
			...
			fn: function(data) {
				if(data) {
					$.ajax({
						...
						type:"POST",
						dataType:"json",
						data:{"payerCode":payerCode, "payerName":payerName, "bizAddress":bizAddress, 
							"taxOrganId":taxOrganId,"industryId":industryId, "bizScope":bizScope, "invoiceType":invoiceType, 
							"legalPerson":legalPerson, "legalIdCard":legalIdCard, "legalMobile":legalMobile, "legalIdCardImageURL":legalIdCardImageURL, 
							"finaceName":finaceName, "finaceIdCard":finaceIdCard, "finaceMobile":finaceMobile, "finaceIdCardImageURL":finaceIdCardImageURL, 
							"taxerName":taxerName, "taxerIdCard":taxerIdCard, "taxerMobile":taxerMobile, "taxerIdCardImageURL":taxerIdCardImageURL, 
							"bizAddressPhone":bizAddressPhone, "userId":userId},
